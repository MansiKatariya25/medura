...
import { Bell, MapPin, Sparkles, QrCode } from "lucide-react";
                ...
                <div className="grid gap-4 md:grid-cols-3">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            className={`relative overflow-hidden rounded-3xl border border-white/5 bg-white/5 p-8 ${feature.className} hover:border-white/10`}
                        >
                            <div
                            ...
                            <h3 className="mb-2 text-xl font-bold text-white font-[family-name:var(--font-dm-sans)]">
                                {feature.title}
                            </h3>
                            ...
                            <div
                                className={`absolute -right-10 -bottom-10 h-32 w-32 rounded-full opacity-20 blur-2xl ${feature.bg}`}
                            />
